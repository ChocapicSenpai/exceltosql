...
(
    ...
    N'Jr. 27 De Mayo Sn (Centro Poblado Chabarbamba A 50 Metros De La Institución Educativa 10564), Huambos, Chota, Cajamarca',
    '38.89037,-77.03196',
    1
),
(
...
(
    ...
    N'C.P. Yunchaco S/N (Ca. La Viña -Final De Calle-2Pisos-Adobe), Cujillo, Cutervo, Cajamarca',
    '-6.37559,-78.82037',
    1
),
(
...
(
    ...
    988193098,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '60601'),
    N'Psje. Cruz De Chalpom N° 100 (A Espaldas Institución Educatica N10236), Cutervo, Cutervo, Cajamarca',
    '-6.37827,-78.81704',
    1
),
(
...
(
    ...
    961872161,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '60701'),
    N'Calle Pomagon Bajo Nº S/N, Bambamarca, Hualgayoc, Cajamarca',
    '-6.68095,-78.52053',
    1
),
(
...
(
    ...
    985684223,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '60701'),
    N'Caserío Auque Mirador S/N (Ref.: Cerca Al Bosque De Piedras), Bambamarca, Hualgayoc, Cajamarca',
    '-6.68095,-78.52053',
    1
),
(
...
(
    ...
    N'Jr. Aviación S/N (Ref. Esquina Con Jr. 28 De Julio), Tacabamba, Chota, Cajamarca',
    '-6.56074,-78.64515',
    1
),
(
...
(
    ...
    N'Jr. Santa Rosa S/N Centro Poblado Chanta Alta, Encañada, Cajamarca, Cajamarca',
    '-6.86297,-78.48169',
    1
),
(
...
(
    ...
    961926259,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '60601'),
    N'Jr. Santiago Delgado Fernandez S/N (Paralela Al Cementerio - Intersección Jr. 15 De Agosto)), Cutervo, Cutervo, Cajamarca',
    '38.89037,-77.03196',
    1
),
(
...
(
    ...
    971003443,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '60801'),
    N'Calle Mariscal Castilla Sector Pueblo Libre Nº 1624, Jaen, Jaen, Cajamarca',
    '-5.70688,-78.80881',
    1
),
(
...
(
    ...
    966902417,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '60410'),
    N'Jr. Rosendo Mendivel Nº 509, Lajas, Chota, Cajamarca',
    '-6.56084,-78.73489',
    1
),
(
...
(
    ...
    N'Ca.Concepción Goicochea Sn(C.P Paccha - Frente A La Plaza De Armas Del C.P La Paccha) , Paccha, Chota, Cajamarca',
    '38.89037,-77.03196',
    1
),
(
...
(
    ...
    981816033,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '60601'),
    N'Av. San Juan Cdra. 8 (Número De Suministro 28472702), Cutervo, Cutervo, Cajamarca',
    '-6.38148,-78.82014',
    1
),
(
    ...
    N'Av. Comercio Nº 157, La Ramada, Cutervo, Cajamarca',
    '-6.21671,-78.55412',
    1
),
(
...
(
    ...
    976001965,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '60601'),
    N'Jr. María Elena Medina 117, Cutervo, Cutervo, Cajamarca',
    '-6.38009,-78.81844',
    1
),
(
...
(
    ...
    988972727,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '60801'),
    N'Av. A Nº 256 Sector Santa Emilia, Jaen, Jaen, Cajamarca',
    '38.89037,-77.03196',
    1
),
(
...
(
    ...
    979235091,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140101'),
    N'Av. Jose Quiñones 416-Urb. Campodonico, Monsefu, Chiclayo, Lambayeque',
    '-6.87367,-79.86943',
    1
),
(
    ...
    979805773,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140101'),
    N'Jose Quiñones N° 416 - Urb. Campodonico , Pitipo, Ferreñafe, Lambayeque',
    '-6.56454,-79.7797',
    1
),
(
...
(
    ...
    954413147,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140101'),
    N'Juan Francisco Ugaz Nº 100 Pj Suazo, Picsi, Chiclayo, Lambayeque',
    '-6.77154,-79.83072',
    1
),
(
...
(
    ...
    996998159,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140101'),
    N'Av. Elvira García Y García N° 230 Jose Olaya, Pomalca, Chiclayo, Lambayeque',
    '-6.7745,-79.84683',
    1
),
(
...
(
    ...
    978086185,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140101'),
    N'Calle La Paz N° 287 Urb. Remigio Silva, Ferreñafe, Ferreñafe, Lambayeque',
    '-6.63167,-79.78962',
    1
),
(
    ...
    979912648,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140101'),
    N'Mz. Mi S/N Ex Fundo Oquendo, Pitipo, Ferreñafe, Lambayeque',
    '-6.56454,-79.7797',
    1
),
(
    ...
    N'Pasaje La Libertad S/N Lote 4 Pj Ramón Castilla, Illimo, Lambayeque, Lambayeque',
    '-6.69712,-79.90171',
    1
),
(
...
(
    ...
    N'Calle San Martin Nro.1133 P.J. Señor De La Justicia, Pacora, Lambayeque, Lambayeque',
    '-6.47156,-79.85342',
    1
),
(
...
(
    ...
    964861592,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140304'),
    N'Mz. A S/N Caserío El Arenal, Jose Leonardo Ortiz, Chiclayo, Lambayeque',
    '-6.74548,-79.83864',
    1
),
(
...
(
    ...
    972607845,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140105'),
    N'Calle Luis Heysen N° 199 C.P. Encarnación, Patapo, Chiclayo, Lambayeque',
    '-6.76558,-79.82224',
    1
),
(
    ...
    941958955,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140105'),
    N'Mza E Lote 32 Pp.Jj. Virgen De Guadalupe (Por La Derrama Magisterial), Saña, Chiclayo, Lambayeque',
    '38.89037,-77.03196',
    1
),
(
...
(
    ...
    943894263,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140105'),
    N'Cl. Santa Rosa Mz A Lote 9 Pj Villa El Triunfo, Pueblo Nuevo, Ferreñafe, Lambayeque',
    '-6.63249,-79.78864',
    1
),
(
...
(
    ...
    978825881,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140105'),
    N'Calle Gran Chimú N° 108 Pj. Jorge Chavez, Tuman, Chiclayo, Lambayeque',
    '-6.74884,-79.84052',
    1
),
(
...
(
    ...
    948117866,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140105'),
    N'Prolongacion Mexico Oeste Nº 901- P.J. Maria Parado De Bellido, Pimentel, Chiclayo, Lambayeque',
    '-6.75734,-79.82345',
    1
),
(
    ...
    978726014,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140105'),
    N'Pardo Y Miguel Nº 379, Oyotun, Chiclayo, Lambayeque',
    '-6.75886,-79.83211',
    1
),
(
...
(
    ...
    990360769,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140105'),
    N'P.J. Santa Lucia Mza. A Lote. 10 (Sal. A Ferreñafe, Pasado Grifo Rosario), Santa Rosa, Chiclayo, Lambayeque',
    '-6.88416,-79.91781',
    1
),
(
...
(
    ...
    952064497,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140106'),
    N'Cl Demetrio Acosta Mz 147 Lote 36, Pitipo, Ferreñafe, Lambayeque',
    '-6.56454,-79.7797',
    1
),
(
...
(
    ...
    N'Cal. Prolongación Angel Gonzales Mz. B Lote 9 Aa.Hh. Pedro Ruiz Gallo, Jayanca, Lambayeque, Lambayeque',
    '-6.39372,-79.82049',
    1
),
(
    ...
    968186915,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140301'),
    N'Calle Emiliano Niño Mza H Lote1 P.J. San Martin, Chiclayo, Chiclayo, Lambayeque',
    '-6.77518,-79.862',
    1
),
(
...
(
    ...
    986237414,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140301'),
    N'Calle San Antonio N° 427 - Pp.Jj. San Martin, Incahuasi, Ferreñafe, Lambayeque',
    '38.89037,-77.03196',
    1
),
(
...
(
    ...
    981769186,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140305'),
    N'Mz A Lote S/N Caserio Solecape, Pitipo, Ferreñafe, Lambayeque',
    '-6.56454,-79.7797',
    1
),
(
    ...
    N'Pasaje Bolivar Nº 359, Olmos, Lambayeque, Lambayeque',
    '-5.98808,-79.74688',
    1
),
(
...
(
    ...
    978800129,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140108'),
    N'Pp.Jj San Jose Monsefu Mz K Lote 2, Ferreñafe, Ferreñafe, Lambayeque',
    '-6.63167,-79.78962',
    1
),
(
...
(
    ...
    956379012,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140308'),
    N'Cas. Las Norias . (A 10 Km De La Ciudad De Olmos), Pueblo Nuevo, Ferreñafe, Lambayeque',
    '-6.63962,-79.79768',
    1
),
(
...
(
    ...
    978100064,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140308'),
    N'C.P. El Puente S/N (Al Lado Del Colegio), Ferreñafe, Ferreñafe, Lambayeque',
    '-6.63167,-79.78962',
    1
),
(
...
(
    ...
    N'Caserio El Espinal S/N, Incahuasi, Ferreñafe, Lambayeque',
    '-6.22678,-79.30481',
    1
),
(
...
(
    ...
    932057716,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140110'),
    N'Mz."A" 00007 Caserio Chilcal Alto S/N, Saña, Chiclayo, Lambayeque',
    '-6.77685,-79.84423',
    1
),
(
...
(
    ...
    916327429,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140309'),
    N'Av. San Pablo Nº 133 , Chongoyape, Chiclayo, Lambayeque',
    '-6.76196,-79.84495',
    1
),
(
...
(
    ...
    N'Cal. Miguel Pasco 296, Pitipo, Ferreñafe, Lambayeque',
    '-6.56454,-79.7797',
    1
),
(
...
(
    ...
    N'Cal. Dos De Mayo 98, Ferreñafe, Ferreñafe, Lambayeque',
    '-6.64449,-79.78999',
    1
),
(
...
(
    ...
    N'Calle José Galán López 266. Urb. El Pescador, Jose Leonardo Ortiz, Chiclayo, Lambayeque',
    '-6.74548,-79.83864',
    1
),
(
    ...
    N'Calle 8 De Octubre Nº 351 Mz C Lote 2, Jose Leonardo Ortiz, Chiclayo, Lambayeque',
    '-6.74574,-79.84081',
    1
),
(
...
(
    ...
    N'Calle Real Nº 462, Jose Leonardo Ortiz, Chiclayo, Lambayeque',
    '-6.74901,-79.85786',
    1
),
(
...
(
    ...
    934577396,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140312'),
    N'Campiña Zapotal S/N, Motupe, Lambayeque, Lambayeque',
    '-6.15218,-79.71467',
    1
),
(
    ...
    973329731,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '140312'),
    N'Calle Federico Villarreal Nº 891, Motupe, Lambayeque, Lambayeque',
    '-6.1559,-79.72047',
    1
),
(
...
(
    ...
    954849119,
    (SELECT UbigeoId FROM dbo.Ubigeo WHERE NumeroUbigeo = '150122'),
    N'Av. Diagonal Nº 380 Of. 201, Chongoyape, Chiclayo, Lambayeque',
    '-6.76025,-79.83187',
    1
),
(
